  ...
  return (
    <div style={{ position: "relative", height: "100%", width: "100%" }}>
      ...
      <div className="absolute left-0 right-0 z-[400] pointer-events-none" style={{ bottom: 'env(safe-area-inset-bottom, 0px)' }}>
        <div className="pointer-events-auto w-full bg-white/80 dark:bg-black/60 text-[9px] md:text-[11px] text-gray-600 dark:text-gray-400 px-2 md:px-3 py-0.5 leading-snug text-right md:text-center">
          {mapStyle === "satellite" ? (
            ...
            <>&copy; <a href="https://leafletjs.com" target="_blank" rel="noopener noreferrer" className="underline">Leaflet</a> &nbsp;|&nbsp; &copy; <a href="https://carto.com/" target="_blank" rel="noopener noreferrer" className="underline">CARTO</a> &nbsp;|&nbsp; <a href="https://www.regie-energie.qc.ca" target="_blank" rel="noopener noreferrer" className="underline">Régie de l&apos;énergie</a> &nbsp;|&nbsp; &copy; <a href="https://www.linkedin.com/in/mathieu-fournier-4977591bb" target="_blank" rel="noopener noreferrer" className="underline">Mathieu Fournier</a> &nbsp;|&nbsp; <a href="/tech" target="_blank" rel="noopener noreferrer" className="underline">À propos</a></>
          ) : (
            <>&copy; <a href="https://leafletjs.com" target="_blank" rel="noopener noreferrer" className="underline">Leaflet</a> &nbsp;|&nbsp; &copy; <a href="https://www.openstreetmap.org/copyright" target="_blank" rel="noopener noreferrer" className="underline">OpenStreetMap</a> &nbsp;|&nbsp; <a href="https://www.regie-energie.qc.ca" target="_blank" rel="noopener noreferrer" className="underline">Régie de l&apos;énergie</a> &nbsp;|&nbsp; &copy; <a href="https://www.linkedin.com/in/mathieu-fournier-4977591bb" target="_blank" rel="noopener noreferrer" className="underline">Mathieu Fournier</a> &nbsp;|&nbsp; <a href="/tech" target="_blank" rel="noopener noreferrer" className="underline">À propos</a></>
          )}
        </div>
      </div>
      {data && (
