  ...
  return (
    <div style={{ position: "relative", height: "100%", width: "100%" }}>
      ...
      <div className="absolute left-0 right-0 z-[400] pointer-events-none" style={{ bottom: 'env(safe-area-inset-bottom, 0px)' }}>
        <div className="pointer-events-auto w-full bg-white/80 dark:bg-black/60 text-[9px] md:text-[11px] text-gray-600 dark:text-gray-400 px-2 md:px-3 py-0.5 leading-snug text-right">
          {mapStyle === "satellite" ? (
